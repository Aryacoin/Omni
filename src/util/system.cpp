...
const char * const BITCOIN_CONF_FILENAME = "aryacoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Aryacoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Aryacoin";
#else
    // Unix
    return pathRet / ".aryacoin";
#endif
#endif
}
