...
static bool getDisclaimerDialogResult()
{
    ...
    "By default this software will use your existing Aryacoin wallet, including spending "
    "aryacoins contained therein (for example for transaction fees or trading).\n\n"
    ...
    "EXPERIMENTAL. Your wallet data, aryacoins and Omni Layer tokens may be lost, "
    ...
    "PLEASE DO NOT use wallet(s) with significant amounts of aryacoins or Omni Layer "
