    ...
    platformStyle(_platformStyle)
{
    ...
    // Transactions page, Omni transactions in first tab, AYA only transactions in second tab
    ...
    txTabHolder->addTab(bitcoinTXTab,tr("Aryacoin"));
    ...
    sendTabHolder->addTab(sendCoinsTab,tr("Aryacoin"));
