...
BOOST_AUTO_TEST_CASE(alert_positive_authorization)
{
    ...
    BOOST_CHECK(CheckAlertAuthorization("AexoDusyQfrYZnUfNWGwWLt2oKoviRSB38"));
}
...
BOOST_AUTO_TEST_CASE(alert_manual_sources)
{
    ...
    BOOST_CHECK(CheckAlertAuthorization("AexoDusyQfrYZnUfNWGwWLt2oKoviRSB38")); // should still be authorized
    BOOST_CHECK(!CheckAlertAuthorization("1JwSSubhmg6iPtRjtyqhUYYH7bZg3Lfy1T"));
