    ...
    if (request.fHelp || request.params.size() != 9)
        throw runtime_error(
            RPCHelpMan{"omni_createpayload_issuancefixed",
               ...
               RPCExamples{
                   HelpExampleCli("omni_createpayload_issuancefixed", "2 1 0 \"Companies\" \"Aryacoin Mining\" \"Quantum Miner\" \"\" \"\" \"1000000\"")
                   + HelpExampleRpc("omni_createpayload_issuancefixed", "2, 1, 0, \"Companies\", \"Aryacoin Mining\", \"Quantum Miner\", \"\", \"\", \"1000000\"")
               }
            }.ToString());
    ...
    if (request.fHelp || request.params.size() != 13)
        throw runtime_error(
            RPCHelpMan{"omni_createpayload_issuancecrowdsale",
               ...
               RPCExamples{
                   HelpExampleCli("omni_createpayload_issuancecrowdsale", "2 1 0 \"Companies\" \"Aryacoin Mining\" \"Quantum Miner\" \"\" \"\" 2 \"100\" 1483228800 30 2")
                   + HelpExampleRpc("omni_createpayload_issuancecrowdsale", "2, 1, 0, \"Companies\", \"Aryacoin Mining\", \"Quantum Miner\", \"\", \"\", 2, \"100\", 1483228800, 30, 2")
               }
            }.ToString());
