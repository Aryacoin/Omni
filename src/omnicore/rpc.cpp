        ...
        throw runtime_error(
                RPCHelpMan{"omni_getnonfungibletokendata",
                   ...
                   RPCResult{
                       ...
                       "    \"owner\" : \"owner\",             (string) the Aryacoin address of the owner\n"
        ...
        throw runtime_error(
                RPCHelpMan{"omni_getproperty",
                   ...
                   RPCResult{
                       ...
                       "  \"issuer\" : \"issuer\"                 (string) the Aryacoin address of the issuer on record"
...
static UniValue omni_getactivedexsells(const JSONRPCRequest& request)
{
    ...
    for (OfferMap::iterator it = my_offers.begin(); it != my_offers.end(); ++it) {
        ...
        responseObj.pushKV("aryacoindesired", FormatDivisibleMP(bitcoinDesired));
...
static UniValue omni_getinfo(const JSONRPCRequest& request)
{
    ...
    infoResponse.pushKV("aryacoincoreversion", BitcoinCoreVersion());
